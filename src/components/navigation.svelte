<!--  левая часть раскладки в "/routes/home/+layout.svelte" : кнопки действий -->
<script>
	// $app/stores/page -> загружается [автоматической] "load"-функцией (+page/+layout)*.svelte, 
	// в которую вставляется данный svelte-компонент
